...
namespace Doublsb.Dialog
{
    public class DialogManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // 20221106 HowWang Add
            var click = Observable.EveryUpdate().Where(_ => Input.GetMouseButtonUp(0));

            // .ThrottleFirst(TimeSpan.FromMilliseconds(500)).Subscribe(_ =>
            // {
            //     print("Update");
        ...
        //改在滑鼠左鍵點下時呼叫Click_Window()     20221106 HowWang modified
        ...
        //         CallAudio.Play();
        //
        //         AudioManager.inst.PlaySFX(E_PadkoVoice.haha.ToString());
        //     }
        // }
